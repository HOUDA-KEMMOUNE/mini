...
SRC = minishell.c lexer.c lexer_core.c lexer_utils.c lexer_support.c lexer_helper.c lexer_errors.c error_msg.c parsing_cd.c expander.c expander2.c parsing_export.c\
	par_exec_echo.c echo_helpers.c echo_utils.c env.c parsing_env.c parsing_unset.c parsing.c parsing_exit.c parsing_ls.c\
	...
	cd_exe_helper.c pipes.c redirection_utils.c main_helpers.c shell_loop.c command_utils.c
